...
class CourseInstanceServiceTest {
    ...
    void setUp() {
        ...
        when(messageSource.getMessage(eq("course.instance.not.found"), any(), any()))
                .thenReturn("Course instance not found");
        when(messageSource.getMessage(eq("course.has.modules"), any(), any()))
                .thenReturn("Невозможно удаление курса, у него есть модули");
    }
